          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 relative z-10">
            ...
            <motion.div
              ...
              className="flex flex-row md:flex-col items-start md:items-center text-left md:text-center relative">
                ...
                <div className="flex-shrink-0 w-24 h-24 rounded-full bg-primary border-4 border-accent flex items-center justify-center mb-0 md:mb-6 mr-6 md:mr-0 relative z-10 shadow-[0_0_30px_rgba(30,120,255,0.2)]">
                  <step.icon className="w-10 h-10 text-white" />
                  <div className="absolute -top-2 -right-2 w-8 h-8 bg-white text-primary font-bold rounded-full flex items-center justify-center text-sm">
                    {step.num}
                  </div>
                </div>
